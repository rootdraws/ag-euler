...
/// @title Addresses
/// @notice Base (8453) addresses for the VIRTUAL × Euler deployment (extending VVV cluster).
library Addresses {
    // ─── Euler Core (Base) ───
    ...
    // ─── Tokens ───
    address constant VIRTUAL = 0x0b3e328455c4059EEb9e3f84b5543F74E24e7E1b; // Virtuals Protocol (18 decimals)
    ...
    address constant CHAINLINK_VIRTUAL_USD = 0xEaf310161c9eF7c813A14f8FEF6Fb271434019F7;
}
