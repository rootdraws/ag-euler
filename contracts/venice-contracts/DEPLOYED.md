# Venice (VVV) Cluster — Deployed Addresses (Base 8453)
...
| Contract | Address |
|----------|---------|
| EulerRouter (shared) | `0x0293B19af06dF6CB00323e1e924AA8995bC1718B` |
| VVV/USD Chainlink Adapter | `0x52cACC037E8F6f681718E08BafaEe305FB1e5512` |
| VVV KinkIRM | `0x23bBDD9B5c795626A043a52C7984e6F3EE47BBDf` |
| Fee Receiver | `0x4f894Bfc9481110278C356adE1473eBe2127Fd3C` |

## VVV Markets (Steps 1-10)
...
## ZRO Extension (Steps 11-17)

| Contract | Address |
|----------|---------|
| ZRO/USD Chainlink Adapter | `0x9D39B08C040501c0977274F865cD11891BF3c1d2` |
