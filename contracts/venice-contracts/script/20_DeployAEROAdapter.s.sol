...
/// @title 20_DeployAEROAdapter
/// @notice Step 20: Deploy Chainlink AERO/USD oracle adapter.
///
/// @dev Run:
///      source .env && forge script script/20_DeployAEROAdapter.s.sol \
...
contract DeployAEROAdapter is Script {
    ...
    function run() external {
        ...
        console.log("\n=== STEP 20 COMPLETE: ChainlinkOracle (AERO/USD) ===");
        ...
        console.log("\nPaste into .env, then run 21_DeployAEROIRM.s.sol");
    }
}
