...
/// @title Addresses
/// @notice Base (8453) addresses for the Venice (VVV) × Euler deployment.
library Addresses {
    // ─── Euler Core (Base) ───
    ...
    address constant CHAINLINK_VVV_USD  = 0xaABc55Ca55D70B034e4daA2551A224239890282F;
    address constant CHAINLINK_ZRO_USD  = 0xdc31a4CCfCA039BeC6222e20BE7770E12581bfEB; // 24h heartbeat

    // ─── Existing Oracle Adapters (Base, from OracleAdaptersAddresses.csv) ───
