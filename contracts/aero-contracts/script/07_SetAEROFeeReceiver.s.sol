...
/// @title 07_SetAEROFeeReceiver
/// @notice Step 7: Set fee receiver on AERO borrow vault.
///
/// @dev Prerequisites: AERO_BORROW_VAULT, FEE_RECEIVER must be set in .env
///
/// @dev Run:
///      source .env && forge script script/07_SetAEROFeeReceiver.s.sol \
...
contract SetAEROFeeReceiver is Script {
    function run() external {
        ...
        console.log("\n=== STEP 7 COMPLETE: AERO Fee Receiver Set ===");
