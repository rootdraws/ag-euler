...
/// @title 06_ConfigureAEROCluster
/// @notice Step 6: Configure AERO borrow vault, activate vaults, and add AERO collateral
...
///
/// @dev Run:
///      source .env && forge script script/06_ConfigureAEROCluster.s.sol \
...
contract ConfigureAEROCluster is Script {
    ...
    function run() external {
        ...
        console.log("\n=== STEP 6 COMPLETE: AERO Configured in VVV Cluster ===");
        ...
        console.log("\nRun 07_SetAEROFeeReceiver.s.sol next.");
    }
}
