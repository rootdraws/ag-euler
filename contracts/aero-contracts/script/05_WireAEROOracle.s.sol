...
/// @title 05_WireAEROOracle
/// @notice Step 5: Add AERO/USD adapter to shared EulerRouter and resolve AERO collateral vault.
///
/// @dev Prerequisites (all must be set in .env):
///      EULER_ROUTER, AERO_USD_ADAPTER, AERO_COLLATERAL_VAULT
///
/// @dev Run:
///      source .env && forge script script/05_WireAEROOracle.s.sol \
