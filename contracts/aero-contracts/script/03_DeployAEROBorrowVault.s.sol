...
/// @title 03_DeployAEROBorrowVault
/// @notice Step 3: Deploy AERO borrow vault using the VVV cluster's shared EulerRouter.
///
/// @dev Prerequisites: EULER_ROUTER must be set in .env (from step 3)
///
/// @dev Run:
///      source .env && forge script script/03_DeployAEROBorrowVault.s.sol \
...
contract DeployAEROBorrowVault is Script {
    function run() external {
        ...
        console.log("\n=== STEP 3 COMPLETE: AERO Borrow Vault ===");
        ...
        console.log("\nPaste into .env, then run 04_DeployAEROCollateralVault.s.sol");
    }
}
