...
contract ExactFillSettler_resolveFor is ExactFillSettlerTestBase {
    // ═══════════════════════════════════════════════════════════════
    //  Helpers
    // ═══════════════════════════════════════════════════════════════
    ...
    {
        (order, od,) = _createExactOrder(user, DEFAULT_ORDER_SIZE);
    }
    ...
    function test_resolveFor_wellFormed_outputsReflectOrderSizeAndPremium() external view {
        ...
        // Rollover leg: amount == outputAmount from OriginFillerData (same as orderSize here)
        ...
        // Premium leg: amount == minPremiumPerShare (not overridden, index != 0)
    ...
    function test_resolveFor_wellFormed_bakesOutputAmountIntoFirstOutput() external view {
        ...
        // outputs[0].amount should be the overridden value
        ...
        // outputs[1] should remain unchanged
