...
contract DeployMinimalRouter is Script {
    ...
    function run() public {
        ...
        MinimalRouter router = new MinimalRouter(IPoolManager(POOL_MANAGER));
        console2.log("MinimalRouter deployed:", address(router));
        
        vm.stopBroadcast();
        
        console2.log("");
        console2.log("=== NEXT STEPS ===");
        console2.log("1. Update liquidationKeeper.ts:");
        console2.log("   MINIMAL_ROUTER = '%s'", address(router));
        console2.log("");
        console2.log("2. Test the V4 integration!");
    }
}
