...
/// @title USDCChainlinkOracle
/// @custom:security-contact security@warren.xyz
/// @author Warren Protocol
/// @notice PriceOracle adapter for Chainlink USDC/USD price feed
...
contract USDCChainlinkOracle is BaseAdapter {
    /// @inheritdoc IPriceOracle
    string public constant name = "USDCChainlinkOracle";
    ...
    /// @notice Deploy a USDCChainlinkOracle.
